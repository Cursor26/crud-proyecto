...
/** Evita que el submenú quede recortado por el sidebar; con strategy fixed el % en width sería del viewport — ver ancho en App.css. */
const SIDEBAR_NAV_DROPDOWN_POPPER = {
  strategy: 'fixed',
  modifiers: [
    {
  ...
  return (
    <div className="dashboard-shell d-flex vh-100" style={{ overflow: 'hidden' }}>
      <div className="dashboard-sidebar vh-100 p-4 d-flex flex-column shadow-lg" style={{ width: '280px', minWidth: '280px' }}>
        <div className="text-white mb-2 pb-4 border-bottom dashboard-sidebar-divider flex-shrink-0">
        ...
        <Nav className="flex-column flex-grow-1" activeKey={key} onSelect={handleNavSelect}>
          ...
          {mostrarContratos && (
            <NavDropdown
              ...
              popperConfig={SIDEBAR_NAV_DROPDOWN_POPPER}
            >
