...
const NOMBRE_MODULO = 'Matadero vivo';
 ...
 */
function MataderoVivoInteractivo({ registros }) {
  const { user } = useAuth();
  ...
  const [sufijo, setSufijo] = useState('Kg');
  ...
  const copyRes = async () => {
    ...
    const t = [
      'Matadero vivo — resumen (herramienta interactiva)',
  ...
  const exportarSerieCsv = () => {
    ...
    a.download = `serie_matadero_${ivDesde || 'x'}_${ivHasta || 'x'}.csv`;
    a.click();
  ...
  const exportarSerieCsvCompleto = () => {
    exportarProduccionEstadisticaCSV({
      ...
      nombreBase: 'AEPG_serie_matadero',
    });
  };
  ...
  return (
    <Card className="mb-3 border-0 shadow-sm">
      <Card.Header as="h2" className="h5 mb-0 py-3 d-flex flex-wrap align-items-center gap-2">
        ...
        Herramientas interactivas — Matadero vivo (16)
        <span className="text-muted small ms-auto" style={{ fontWeight: 400 }}>
          Gráficos, filtros y simulaciones (métrica Cab / Kg del módulo).
        </span>
      </Card.Header>
      <Card.Body>
        ...
        <div className="row g-2 mb-3">
          <div className="col-md-4">
            ...
            >
              ...
              <option value="categorias">Suma categorías (Kg y Cab en detalle)</option>
            </Form.Select>
          </div>
          {modoMetrica === 'sufijo' && (
            <div className="col-md-4">
        ...
        <Accordion alwaysOpen>
          ...
          <Accordion.Item eventKey="I15">
            ...
            <Accordion.Body>
              ...
              <p className="small text-muted mt-2 mb-0">XLSX con formato AEPG (como contratación). XLS: hoja única con bloques. <strong>Más formatos</strong>: misma malla informativa en PDF, Word, JSON, HTML, TSV.</p>
            </Accordion.Body>
          </Accordion.Item>
...
export default MataderoVivoInteractivo;
