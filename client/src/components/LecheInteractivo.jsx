 ...
 */
function LecheInteractivo({ registros }) {
  const { user } = useAuth();
  ...
  const [sufijo, setSufijo] = useState('Produccion_total');
  ...
  const copyRes = async () => {
    ...
    const t = [
      'Leche — resumen (herramienta interactiva)',
  ...
  const exportarSerieCsv = () => {
    ...
    a.download = `serie_leche_${ivDesde || 'x'}_${ivHasta || 'x'}.csv`;
    a.click();
  ...
  return (
    <Card className="mb-3 border-0 shadow-sm">
      <Card.Header as="h2" className="h5 mb-0 py-3 d-flex flex-wrap align-items-center gap-2">
        ...
        Herramientas interactivas — Leche (16)
        <span className="text-muted small ms-auto" style={{ fontWeight: 400 }}>
          Indicadores por rango, sufijos y categorías; producción y vacas.
        </span>
      </Card.Header>
      <Card.Body>
        ...
        <div className="row g-2 mb-3">
          <div className="col-md-4">
            ...
            >
              <option value="clásico">Producción total (totales y plantas)</option>
              <option value="sufijo">Columna por sufijo (suma categorías + total1/2)</option>
              <option value="categorias">Suma categorías (Produccion_total y Vacas_total)</option>
            </Form.Select>
          </div>
          {modoMetrica === 'sufijo' && (
            <div className="col-md-4">
        ...
        <Accordion alwaysOpen>
          ...
          <Accordion.Item eventKey="I5">
            <Accordion.Header>5) Plantas vs resto (producción) — apilado</Accordion.Header>
            <Accordion.Body>
                ...
                <div style={{ height: 200 }}>
                  <ResponsiveContainer>
                    <BarChart data={hmUnBar} layout="vertical" margin={{ top: 8, right: 16, left: 40, bottom: 0 }} barSize={32}>
                      ...
                      />
                      <Bar dataKey="h" name="Plantas" stackId="a" fill="#d63384" />
                      <Bar dataKey="m" name="Resto" stackId="a" fill="#0dcaf0" />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
            ...
            <Accordion.Body>
              <div className="d-flex flex-wrap gap-2 align-items-center">
                <Button variant="outline-success" size="sm" onClick={exportarSerieCsv}>
                  <i className="bi bi-filetype-csv" aria-hidden="true" /> CSV (serie)
                </Button>
              ...
              <p className="small text-muted mt-2 mb-0">Misma línea gráfica que reportes AEPG (contratación). XLS: compatibilidad Excel 2003. <strong>Más formatos</strong>: informe aplanado en PDF, Word, JSON, etc.</p>
            </Accordion.Body>
          </Accordion.Item>
...
export default LecheInteractivo;
