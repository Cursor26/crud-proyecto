...
import ContratosCorreoPlantillasConfig from './ContratosCorreoPlantillasConfig';
    ...
    <div className="contratos-correo-config">
      ...
      <div className="card shadow-sm border-0 mb-3">
        <div className="card-body">
          <h5 className="card-title mb-2">Mensajes de los correos</h5>
          <ContratosCorreoPlantillasConfig puedeEditar={puedeEditar} />
        </div>
      </div>
